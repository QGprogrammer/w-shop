...
import com.ven.w.shop.commons.utils.EmailSendUtils;
import com.ven.w.shop.web.ui.api.UsersApi;
import com.ven.w.shop.web.ui.constant.SystemConstants;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "peterven@126.com");
            // 将会员信息放入 Session
